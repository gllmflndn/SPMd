...
if ~isempty(get(f,'userdata'))
    ...
    h4 = axes('Position',[0.55 0.44 0.40 0.20],...
        'Visible','on',...
        'NextPlot','add', ...
        'UserData',D,...
        'Tag','in_MD_plot');
