% $Id: spmd.m,v 1.8 2008/02/13 16:28:51 nichols Exp $
function spmd(varargin)
...
h = [h uicontrol(Finter,'String','Cancel',...
	...
	'CallBack','spmd(''delete'',''tag'',''hMS_UI'')',...
	'ForegroundColor','r')];
...
if strcmp(type,'compute'),
  h = [h uicontrol(Finter,'String','GO!',...
	...
	'CallBack','spmd(''go'',''ms_comp'');spmd(''delete'',''tag'',''hMS_UI'')',...
	'ForegroundColor','r')];
  MS.Comp = Ch;
elseif strcmp(type,'visual'),
  h = [h uicontrol(Finter,'String','GO!',...
	'unit','normalized',...
    'Position',[Lx+2*(Lx+LX) Ypos+Ly 0.16  LY],...
	'CallBack','spmd(''go'',''ms_visual'');spmd(''delete'',''tag'',''hMS_UI'')',...
	'ForegroundColor','r')];
...
h = [h uicontrol(Finter,'String','Cancel',...
		 ...
		 'CallBack','spmd(''delete'',''tag'',''hSS_UI'')',...
		 'ForegroundColor','r')];
...
if strcmp(type,'compute'),
  h = [h uicontrol(Finter,'String','GO!',...
		   ...
		   'CallBack','spmd(''go'',''ss_comp'');spmd(''delete'',''tag'',''hSS_UI'')',...
		   'ForegroundColor','r')];
  SS.Comp = Ch;
elseif strcmp(type,'visual'),
  h = [h uicontrol(Finter,'String','GO!',...
	'unit','normalized',...
    'Position',[Lx+(Lx+LX) Ypos+Ly 0.22 LY],...
	'CallBack','spmd(''go'',''ss_visual'');spmd(''delete'',''tag'',''hSS_UI'')',...
	'ForegroundColor','r')];
  SS.Visual = Ch;
end
