...
% $Id: spmd_SptlBar.m,v 1.2 2004/12/27 16:38:57 huizhang Exp $

function varargout = spmd_SptlBar(varargin)
% Create toolbar in the figure
% FORMAT spmd_SptlBar(varargin)
%   varargin - different types of options
% 
% _______________________ Functions called ___________________________
%
%       spm_figure
%       spmd_orthviews
